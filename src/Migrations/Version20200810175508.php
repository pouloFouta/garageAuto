 ...
 */
final class Version20200810175508 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE vehicule CHANGE numero_chassis numero_chassis VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
