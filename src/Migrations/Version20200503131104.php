 ...
 */
final class Version20200503131104 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE specialite (id INT AUTO_INCREMENT NOT NULL, nom_specialite VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE personne ADD points_bonus INT DEFAULT NULL, DROP specialite');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD specialite VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci, DROP points_bonus');
    }
}
